                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/lemburp') }}">
                        ...
                        <div class="form-group{{ $errors->has('pegawai_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <center><label><font color="red"> Pegawai tidak memiliki data dari kategori lembur!! Anda Harus mengisi dahulu kategori lembur buat pegawai!!</font></label></center><br>
