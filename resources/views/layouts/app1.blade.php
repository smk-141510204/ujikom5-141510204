...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{url('tampilan/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="{{url('tampilan/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <!-- Plugin CSS -->
    <link href="{{url('tampilan/vendor/magnific-popup/magnific-popup.css')}}" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="{{url('tampilan/css/creative.min.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <!-- jQuery -->
    <script src="{{url('tampilan/vendor/jquery/jquery.min.js')}}"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="{{url('tampilan/vendor/bootstrap/js/bootstrap.min.js')}}"></script>

    <!-- Plugin JavaScript -->
    <script src="{{url('https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js')}}"></script>
    <script src="{{url('tampilan/vendor/scrollreveal/scrollreveal.min.js')}}"></script>
    <script src="{{url('tampilan/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>

    <!-- Theme JavaScript -->
    <script src="{{url('tampilan/js/creative.min.js')}}"></script>
